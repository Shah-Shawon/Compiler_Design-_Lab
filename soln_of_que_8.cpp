...
vector<string>keywords = {
    ...
    "char","string","void","auto","new","swith",
...
int main() {
    ...
    freopen("input_of_que_8.txt", "r", stdin);
    string str;

    while (getline(cin, str)) {
        if (find(keywords.begin(), keywords.end(), str) != end(keywords)) {
            cout << str << " : " << "Keyword "<< endl;;
        } else if (find(arithmatic_operators.begin(), arithmatic_operators.end(), str) != arithmatic_operators.end()) {
